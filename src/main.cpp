...
///   char *nasap1 = "ARRLFM_S18_AP";
  ...
  // char *nasap1 = "ARRLFM_PEF_RLMN";
   char *nasap1 = "ARRLFM_S18H-16_RLMN";
 ...
 //  Arrlfm< Asap< BVTtipo2<sdsl::s18::vector<16>, sdsl::s18::rank_support<1,16> , sdsl::s18::select_support<1,16>> , uint64_t ,wt_int<>> >  TWA(path_bin,bwt,civ,0);  
 ...
 //Arrlfm< Asap< pef_vector_opt_vigna< rank_support_v5<1>, select_support_mcl<1>, 1024 >, uint64_t ,wt_ap<>> >  TWA(path_bin,bwt,civ,0);  
   // Arrlfm< Asap< BVTtipo2<sdsl::s18::vector<16>, sdsl::s18::rank_support<1,16> , sdsl::s18::select_support<1,16>>, uint64_t ,wt_ap<>> >  TWA(path_bin,bwt,civ,0);  
 ...
 //  Arrlfm< Asap< SDBV, uint64_t ,wt_rlmn<sd_vector<>,sd_vector<>::rank_1_type,sd_vector<>::select_1_type,wt_int<>   >  > > TWA(path_bin,bwt,civ,0);  
  //  Arrlfm< Asap<pef_vector_opt_vigna< rank_support_v5<1>, select_support_mcl<1>, 1024 >, uint64_t ,wt_rlmn<sd_vector<>,sd_vector<>::rank_1_type,sd_vector<>::select_1_type,wt_int<>   >  > > TWA(path_bin,bwt,civ,0);  
   Arrlfm< Asap< BVTtipo2<sdsl::s18::vector<16>, sdsl::s18::rank_support<1,16> , sdsl::s18::select_support<1,16>>, uint64_t ,wt_rlmn<sd_vector<>,sd_vector<>::rank_1_type,sd_vector<>::select_1_type,wt_int<>   >  > > TWA(path_bin,bwt,civ,0);  
 ...
 //Arrlfm< Asap< BVTtipo2<sdsl::s18::vector<16>, sdsl::s18::rank_support<1,16> , sdsl::s18::select_support<1,16>>, uint64_t ,wt_rlmn<sd_vector<>,sd_vector<>::rank_1_type,sd_vector<>::select_1_type,wt_ap<>   >  > > TWA(path_bin,bwt,civ,0);  
  ...
  //Arrlfm< Asap< BVTtipo2<sdsl::s18::vector<16>, sdsl::s18::rank_support<1,16> , sdsl::s18::select_support<1,16>>, uint64_t ,rl_runs< 64,wt_ap<> > > >  TWA(path_bin,bwt,civ,0);  
  ...
  // Arrlfm< Asap< pef_vector_opt_vigna< rank_support_v5<1>, select_support_mcl<1>, 1024 >, uint64_t ,rl_runs< 64,wt_rlmn<sd_vector<>,sd_vector<>::rank_1_type,sd_vector<>::select_1_type,wt_int<>  > > > >  TWA(path_bin,bwt,civ,0);  
   //Arrlfm< Asap< BVTtipo2<sdsl::s18::vector<16>, sdsl::s18::rank_support<1,16> , sdsl::s18::select_support<1,16>>, uint64_t ,rl_runs< 64,wt_rlmn<sd_vector<>,sd_vector<>::rank_1_type,sd_vector<>::select_1_type,wt_int<>  > > > >  TWA(path_bin,bwt,civ,0);  
